...
Eigen::MatrixXd HHO_LocVarDiff::diffusion_operator(HybridCore &hho, const size_t iT) const {
...
Eigen::VectorXd HHO_LocVarDiff::VertexValues(HybridCore& hho, const Eigen::VectorXd Xh, const char from_dofs) {
  const auto mesh = hho.get_mesh_ptr();
