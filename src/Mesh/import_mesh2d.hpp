...
#ifndef IMPORT_MESH2D_HPP
#define IMPORT_MESH2D_HPP
...
/// The Mesh2DReaderTyp2 class provides functions to read a .typ2 mesh file
class Mesh2DReaderTyp2 {
public:
    /**
    ...
    */
    Mesh2DReaderTyp2(std::string file_name);  ///< class to read the cells and vertices in a .typ2 file
    /**
...
};     // end namespace MeshFramework2D
#endif /* IMPORT_MESH2D_HPP */
