...
Typically, these values are then passed on to \hyperlink{classHArDCore2D_1_1HybridCore_a1b9e2d375b5a3a578b79fb2cc0100b6b}{gram\+\_\+matrix(f\+\_\+quad,g\+\_\+quad,Nf,Ng,quad\+TE,sym,weight)} which computes a ``generalised\textquotesingle{}\textquotesingle{} Gram matrix $(\int weight*f_i*g_j)_{ij}$ of the families of functions $(f_1,\ldots,f_{Nf})$ and $(g_1,\ldots,g_{Ng})$, provided at the quadrature notes by {\ttfamily f\+\_\+quad} and {\ttfamily g\+\_\+quad} (here, {\ttfamily sym} is a boolean indicating if the matrix is expected to be symmetric). This Gram matrix method is useful to compute mass and stiffness matrices.
